...
public class Unpaid_order extends ArrayAdapter {
        ...
        public Unpaid_order(Activity activity,int orderNo, int[] id ,String[] prodname,String[] image_url,String[] prodstatus,String[] prodquant,String[] prodprice,String[] proddescrpt,
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if (v == null) {
                ...
                v = inflater.inflate(R.layout.unpaid_order_adapter, parent, false);
            ...
            viewholder.restdet.setText("Restaurant name :"+restname+"\n"+"Location :"+restlocation+"\n"+"Phone no. "+restno);

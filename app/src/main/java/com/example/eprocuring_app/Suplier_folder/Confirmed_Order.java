...
public class Confirmed_Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDeliveredorderlisrequst(Procure_Url.getconfirmed_order_URL);
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Order_Adapter adapter = new Order_Adapter(Confirmed_Order.this, id,name, image_url, status, quantity, amount, descriptions, locat, user, no, date, date);

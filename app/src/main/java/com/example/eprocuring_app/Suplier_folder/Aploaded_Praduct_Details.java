...
public class Aploaded_Praduct_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aploaded__praduct__details);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            pricetxt.setText("Price :"+brand);
                            quantity.setText("Quantity :"+price);

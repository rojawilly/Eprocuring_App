...
public class Derivered_order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_derivered_order);
        listView = findViewById(R.id.deriveredlstv);
        getDeliveredorderlisrequst(Procure_Url.getderivered_order_URL);
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Order_Adapter adapter = new Order_Adapter(Derivered_order.this, id,name, image_url, status, quantity, amount, descriptions, locat, user, no, date, date);
                            ...
                            e.printStackTrace();
                            Toast.makeText(getApplicationContext(), "Aploaded error on catch " + e, Toast.LENGTH_LONG).show();
                        }
                    }
